...
//Eliminar Clase con ChatBoxActivity
public class ChatBoxAdapter  extends RecyclerView.Adapter<ChatBoxAdapter.MyViewHolder> {
    private List<Notificaciones> MessageList;
...
// we will passe  it when making an instance of the adapter object in our activity
    ...
    public ChatBoxAdapter(List<Notificaciones>MessagesList) {
    ...
    public void onBindViewHolder(final ChatBoxAdapter.MyViewHolder holder, final int position) {
        ...
        Notificaciones m = MessageList.get(position);
